...
1. **在线 Demo**：已发布到 GitHub Pages；使用浏览器本地存储完成筛选、收藏、标签和跟进操作。公开仓库见 [GitHub](https://github.com/yibohanthu-hub/ai-vc-opportunity-radar)。
...
- 「实时待核验」展示 InfoQ 中文、量子位与活动行中国大陆城市目录实际采集的候选队列；候选保留来源、抓取时间和未知字段，不自动补全为正式投研档案。
